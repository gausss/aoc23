private data class SchematicNumber(val value: Int, val start: Position, val end: Position) {
...
private data class EngineSchematic(val numbers: Set<SchematicNumber>, val symbols: Set<Position>)

private fun parseSchematic(lines: List<String>): EngineSchematic {
